...
//break
  ...
  else if(flexValue2>576 && flexValue2<607){
    ring.write(30);
  }
  else if(flexValue2>607 && flexValue2<638){
    ring.write(60);
  }
  else if(flexValue2>638 && flexValue2<669){
    ring.write(90);
  }
  else if(flexValue2>669 && flexValue2<700){
    ring.write(120);
  }
  else if(flexValue2>700 && flexValue2<731){
    ring.write(150);
  }
  else{
    ring.write(180);
  ...
  else if(flexValue3>621 && flexValue3<647){
    middle.write(30);
  }
  else if(flexValue3>647 && flexValue3<673){
    middle.write(60);
  }
